...
namespace Drupal\tide_data_pipeline\Hook;
...
/**
 * Hook implementations for the tide data pipeline module.
 */
class TideDataPipelineHooks {
  ...
  public function fieldWidgetSingleElementFormAlter(&$element, FormStateInterface $form_state, $context) {
    ...
    $element_data['subform']['csv_template_download'] = [
      '#type' => 'item',
      '#title' => t('Dataset'),
      '#description' => t('Click on the link below to download a dataset template. You have to import your dataset using this template before you can create your map. DO NOT change any of the headings in Row 1 of the template or your data won’t display.'),
