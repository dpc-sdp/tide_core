...
namespace Drupal\tide_publication\Hook;
...
/**
 * Hook implementations for the tide publication module.
 */
class TidePublicationHooks {
   ...
   */
  #[Hook('tide_entity_reference_site_enhancer_undo_transform_alter')]
  public function tideEntityReferenceSiteEnhancerUndoTransformAlter(&$data, &$context, &$entity) {
   ...
   */
  #[Hook('tide_entity_reference_site_enhancer_transform_alter')]
  public function tideEntityReferenceSiteEnhancerTransformAlter(&$value, &$context) {
