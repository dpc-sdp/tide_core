...
Feature: Access permissions
  ...
  Scenario: Site Admin role has access to assign roles.
    ...
    And I select "Remove the Site Admin role to the selected user(s)" from "edit-action"
    And I select "Remove the Previewer role to the selected user(s)" from "edit-action"
    And I select "Remove the Editor role to the selected user(s)" from "edit-action"
    And I select "Remove the Approver role to the selected user(s)" from "edit-action"
