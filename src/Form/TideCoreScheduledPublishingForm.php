...
/**
 * Show all scheduled publishing for an entity.
 */
class TideCoreScheduledPublishingForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state): array {
    ...
    $form['table'] = [
      ...
      '#empty' => $this->t('There are no scheduled publishing for @entity', [
        '@entity' => $entity->label(),
      ]),
    ];
    ...
    $form['table']['#rows'] = array_map(
      function (ScheduledTransitionInterface $scheduledTransition) use ($entityStorage) {
        ...
        $row['date'] = $this->dateFormatter->format($time, 'custom', 'd-M-Y - h:i a');
